...
LOG_LEVEL = "INFO"
logger = logging.getLogger("gemmafocus")
...
MAX_TOKENS = 48
SYSTEM_PROMPT = "Only respond in JSON."
RESPONSE_FORMAT = {
    "type": "json_schema",
    "json_schema": {
        "name": "focus_signals",
...
app = FastAPI(title="GemmaFocus", lifespan=lifespan)
...
<html lang="en">
  ...
  <body>
    <main class="frame">
      <header>
        <div>
          <div class="tag">GemmaFocus Demo</div>
          <h1>Gemma Focus</h1>
        </div>
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="GemmaFocus demo")
